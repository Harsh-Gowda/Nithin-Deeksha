        ...
        >
          ...
          <div className="flex flex-col items-center justify-center space-y-2 md:space-y-4">
            <motion.span
              ...
              className="font-script text-7xl sm:text-8xl md:text-[10rem] text-white normal-case leading-none mt-4"
            >
              Nithin
            </motion.span>

            <div className="flex items-center justify-center gap-6 w-full max-w-xs md:max-w-md py-4">
              ...
              >
                <svg className="w-10 h-10 md:w-12 md:h-12 text-gold" viewBox="0 0 24 24" fill="currentColor">
            ...
            <motion.span
              ...
              className="font-script text-7xl sm:text-8xl md:text-[10rem] text-white normal-case leading-none pb-8"
            >
              Deekshitha
            </motion.span>
          </div>
        ...
        <div className="text-center space-y-10 relative z-10">
          ...
          <div className="relative">
            <div className="flex flex-col items-center justify-center space-y-2 mb-20">
              <span className="font-script text-7xl md:text-[7rem] text-black normal-case leading-none pt-4">Nithin</span>

              <div className="flex items-center justify-center gap-6 w-56 md:w-80 py-4">
                <div className="h-[1px] flex-1 bg-gold/30"></div>
                <svg className="w-8 h-8 text-gold/60" viewBox="0 0 24 24" fill="currentColor">
                  <path d="M12 21.35l-1.45-1.32C5.4 15.36 2 12.28 2 8.5 2 5.42 4.42 3 7.5 3c1.74 0 3.41.81 4.5 2.09C13.09 3.81 14.76 3 16.5 3 19.58 3 22 5.42 22 8.5c0 3.78-3.4 6.86-8.55 11.54L12 21.35z" />
                </svg>
                <div className="h-[1px] flex-1 bg-gold/30"></div>
              </div>

              <span className="font-script text-7xl md:text-[7rem] text-black normal-case leading-none pb-4">Deekshitha</span>
            </div>
